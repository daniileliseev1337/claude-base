...
- [[id-volume-graph]] — queryable граф устройства тома ИД (модель зависимостей: акты/ведомости/схемы/документы качества/замечания ТН/нормы/принципы) в формате graphify. id-engineer query'ит вместо «простыни». Редактируемый (`id_volume_extract.json` → `rebuild.py`), обезличен. Пока охват ВиВ.

...
- **На завершении сессии (SessionEnd hook):** `auto-push.ps1` коммитит изменения в whitelist-путях (`agents/`, `skills/`, `memory/`, `session-reports/`, `harvested/`, `CLAUDE.md`) и пушит на origin.

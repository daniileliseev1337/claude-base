...
Источник идеи — аудит чужой базы Claude Code «<организация> (агенты)» от 2026-05-20
(см. отчёт аудит <организация> (от 2026-05-20, отчёт архивирован), раздел 4.4). У них
...
- Сейчас у нас нет LLM-агентов уровня сложности <организация> (s3-lawyer
...
- <организация> отчёт аудит <организация> (от 2026-05-20, отчёт архивирован), раздел 4.4

## История

- 2026-05-20 — создан backlog по результату аудита <организация> и решения

...
Контекст: проектирование <шифр-чертежа> (медицинский комплекс), СКС/ЛВС, 200 шкафов из xlsx → нужны DWG-схемы и планы.
...
- **Сценарий 1 (xlsx → DWG, основной кейс <шифр-чертежа>):**

...
- **Решение: используем активно.** Конкретно: ставим как MCP-сервер для Claude Code (после согласования с пользователем), backend = ezdxf для генерации DXF из xlsx <шифр-чертежа>. P&ID символы могут пригодиться для СКС/ЛВС-схем как структурные блоки. **Это основной кандидат на интеграцию.**

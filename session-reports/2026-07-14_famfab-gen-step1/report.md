...
## Дальше
Ревью схемы владельцем (4 вопроса в gen_schema.md) → шаг 2 спека: gen_bones+gen_muscle,
смоук cube_v2 на живом стенде (deploy.ps1 готов, канал Routes проверить пингом).

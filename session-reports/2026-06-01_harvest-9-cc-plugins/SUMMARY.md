...
| 6 | OpenAI codex-plugin-cc | ⚫ **ОТПАДАЕТ** — ChatGPT auth недоступен в РФ (free tier требует ChatGPT аккаунт, регистрация РФ заблокирована OpenAI). НЕ костылить VPN (анти-паттерн) | идея **cross-model review** ценна → backlog: найти reviewer на РФ-доступной модели (DeepSeek/Qwen/GigaChat/YandexGPT). См. backlog_cross_model_review_rf.md | [06-codex-plugin-cc.md](harvested/06-codex-plugin-cc.md) |

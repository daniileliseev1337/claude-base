...
### Вопрос пользователю
- Есть ли в <организация> юр-функция? Работаете с РФ-договорами или международными?
...
- **На developer-ПК полезно:** внутренние дашборды (`/token-stats` который
  предлагали в #1), сайт <организация>, web-артефакты для команды.
...
## Открытые вопросы
1. Legal — есть юр-функция в <организация>? РФ или международные контракты?

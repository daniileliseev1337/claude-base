...
- 111k stars + MIT — можно взять, перекроить, выкинуть код-секции (для аудитории К-7 они не нужны) и оставить высокоуровневые слайды «Что такое LLM», «Промпт-инжиниринг», «Бизнес-применения», «Этика и риски».

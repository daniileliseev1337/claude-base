...
Альтернатива vector overlay для замены текста в сканированных PDF (КП <организация>, 24 файла). Цель — визуально неотличимая вставка «-20%» в строку «Итоговая сумма (вкл. НДС)» без ручного подбора baseline/кегля.
